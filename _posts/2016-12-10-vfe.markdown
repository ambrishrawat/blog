...
**Uncertainty representation**: All the the believed uncertainties in the mathematical description of a model are stated via functional definitions - prior , likelihood , noise processes, among other expressions. 
